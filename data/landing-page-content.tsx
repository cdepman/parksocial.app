export const LANDING_PAGE_CONTENT = [
  ...
  },
  {
    ...
    description:
      "For easy navigation and interaction with the park, you can find media, history, reviews, and more for features such as:",
    list: [
      "Water fountains",
      "Benches",
      "Statues",
  ...
  },
  {
    ...
    description: "Earn points and distinction for:",
    list: [
