export const LANDING_PAGE_CONTENT = [
  {
    title: "Find and Create Events",
    description:
      "From pick-up frisbee, to yoga, amateur theater, a picnic, a jam, a spontaneous silent disco, or whatever you want to organize!",
    icon: (
      <svg
        width="800px"
        height="800px"
  ...
  },
  {
    ...
    description:
      "For easy navigation and interaction with the park, you can find media, history, reviews, and more for fearures such as:",
    list: [
      "water fountains",
      "benches",
      "statues",
